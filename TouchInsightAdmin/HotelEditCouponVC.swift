...
class HotelEditCouponVC: UIViewController,UITextFieldDelegate,UITextViewDelegate,UIPickerViewDelegate,UIScrollViewDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIGestureRecognizerDelegate,CustomIOS7AlertViewDelegate {
    ...
    @IBAction func btnSaveDataClick(sender: AnyObject) {
        ...
        if imgLogo.image == nil {
            ...
            let sendData = [
                ...
                "providerId": objProviderDic["provider_id"]!,
    ...
    override func viewDidLoad() {
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(HotelEditCouponVC.dismissKeyboard))
        tap.delegate = self
        ...
        let tapAddLogo = UITapGestureRecognizer(target:self, action:#selector(HotelEditCouponVC.imageTapped(_:)))
        imgLogo.userInteractionEnabled = true
        imgLogo.addGestureRecognizer(tapAddLogo)
        
        let tapBgLongDes = UITapGestureRecognizer(target:self, action:#selector(HotelEditCouponVC.btnOpenLongDesriptionClick(_:)))
