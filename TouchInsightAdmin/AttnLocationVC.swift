...
import UIKit
import MapKit
class AttnLocationVC: UIViewController,MKMapViewDelegate,CLLocationManagerDelegate,UITextFieldDelegate{
...
func changeDetial(){
    ...
    override func viewDidLoad() {
        ...
        let lpgr: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(AttnLocationVC.handleLongPress(_:)))
