...
*/
    ...
    func collectionView(collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return appDelegate.facilityHotelDic!["facilities"]!.count
    }
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) ->UICollectionViewCell {
        ...
        print("Facility Image Url :\(appDelegate.facilityHotelDic!["facilities"]![indexPath.row]["images"]!!["icons"]!!["lighten"] as! String)")
        
        if(!appDelegate.facilityHotelStatus[indexPath.row])
        {
            if let url  = NSURL(string: appDelegate.facilityHotelDic!["facilities"]![indexPath.row]["images"]!!["icons"]!!["lighten"] as! String),
            ...
            cell.roomfacLabel.text = (appDelegate.facilityHotelDic!["facilities"]![indexPath.row]["facility_name_en"] as! String)
        }
        else
        {
            if let url  = NSURL(string: appDelegate.facilityHotelDic!["facilities"]![indexPath.row]["images"]!!["icons"]!!["darken"] as! String),
                data = NSData(contentsOfURL: url)
            {
