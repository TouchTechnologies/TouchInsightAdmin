...
class AttnCreateMenuVC: UIViewController,UITextFieldDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate , UITableViewDataSource,UIImagePickerControllerDelegate, UINavigationControllerDelegate,UITableViewDelegate,UIGestureRecognizerDelegate,CustomIOS7AlertViewDelegate {
...
//        self.updateData()
    ...
    override func viewDidLoad() {
        ...
        let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(AttnCreateMenuVC.dismissKeyboard))
        tap.delegate = self
