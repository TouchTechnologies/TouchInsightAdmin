...
import Alamofire
import PKHUD
class AttnImageGalleryVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UICollectionViewDelegate,UICollectionViewDataSource
{
...
//        CoverImg.image = UIImage(named: "bg_cctvdefault.png")
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target:self, action:#selector(AttnImageGalleryVC.imageTapped(_:)))
