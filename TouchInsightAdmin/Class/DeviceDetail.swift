...
//  JOBBKK
//
//  Created by Thirawat Phannet on 14/11/58.
...
extension DeviceDetail: CustomStringConvertible {
...
// MARK: - Equatable
extension DeviceDetail: Equatable {}

public func ==(lhs: DeviceDetail, rhs: DeviceDetail) -> Bool {
    return lhs.description == rhs.description
}

// MARK: - Device.Batterystate: Comparable
extension DeviceDetail.BatteryState: Comparable {}

public func ==(lhs: DeviceDetail.BatteryState, rhs: DeviceDetail.BatteryState) -> Bool {
    return lhs.description == rhs.description
}
