...
class ResRoomInfoVC: UIViewController,UITableViewDataSource,UITableViewDelegate,UIGestureRecognizerDelegate {
...
//        self.performSegueWithIdentifier("toEdit", sender: indexPath)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if let roomName = self.roomNameData["roomTypes"]![indexPath.row]!["room_type_name_en"]!
        {
            ...
            let gestureEdit = UITapGestureRecognizer(target: self, action: #selector(ResRoomInfoVC.handleTap(_:)))
            ...
            let gestureDelete = UITapGestureRecognizer(target: self, action: #selector(ResRoomInfoVC.deleteTap(_:)))
